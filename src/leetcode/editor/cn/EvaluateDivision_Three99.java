...
// 
// Related Topics 深度优先搜索 广度优先搜索 并查集 图 数组 最短路 👍 895 👎 0
...
public class EvaluateDivision_Three99 {
    public static void main(String[] args) {
        Solution solution = new EvaluateDivision_Three99().new Solution();
    }
    ...
    class Solution {
        ...
        public double[] calcEquation(List<List<String>> equations, double[] values, List<List<String>> queries) {
            ...
            for (int i = 0; i < queries.size(); i++) {
                ...
                Integer x = m.get(var1);
                Integer y = m.get(var2);
        ...
        private double connected(int x, int y) {
            int rootX = find(x);
            int rootY = find(y);
