    ...
    class Solution {
        public int minOperationsMaxProfit(int[] customers, int boardingCost, int runningCost) {
            ...
            for (int c : customers) {
                ...
                int t = play * boardingCost - runningCost;
                if (earn + t > earn) {
                    ans = turn;
                }
                earn += t;
