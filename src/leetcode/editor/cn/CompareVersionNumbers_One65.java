...
public class CompareVersionNumbers_One65 {
    public static void main(String[] args) {
        Solution solution = new CompareVersionNumbers_One65().new Solution();
    }
    ...
    class Solution {
        public int compareVersion(String version1, String version2) {
            ...
            while (i < v1.length && j < v2.length) {
                int sum1 = stringToInt(v1[i++]);
                int sum2 = stringToInt(v2[j++]);
                if (sum1 > sum2) {
                    return 1;
                } else if (sum1 < sum2) {
                    return -1;
