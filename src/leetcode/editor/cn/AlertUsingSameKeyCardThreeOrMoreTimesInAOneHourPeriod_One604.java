...
public class AlertUsingSameKeyCardThreeOrMoreTimesInAOneHourPeriod_One604 {
    public static void main(String[] args) {
        Solution solution = new AlertUsingSameKeyCardThreeOrMoreTimesInAOneHourPeriod_One604().new Solution();
    }
    ...
    class Solution {
        ...
        private int toInt(String time) {
            ...
            int h = words[0].charAt(0) * 10 + words[0].charAt(1);
            int m = words[1].charAt(0) * 10 + words[1].charAt(1);
            return h * 60 + m;
        }
    }
