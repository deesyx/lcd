...
// 
// Related Topics 栈 队列 数组 模拟 👍 94 👎 0
...
public class NumberOfStudentsUnableToEatLunch_One700 {
    public static void main(String[] args) {
        Solution solution = new NumberOfStudentsUnableToEatLunch_One700().new Solution();
    }
