...
// s 只包含大写英文字符 
// 
// Related Topics 哈希表 字符串 动态规划 👍 205 👎 0
...
public class CountUniqueCharactersOfAllSubstringsOfAGivenString_Eight28 {
    public static void main(String[] args) {
        Solution solution = new CountUniqueCharactersOfAllSubstringsOfAGivenString_Eight28().new Solution();
    }
        ...
        public int uniqueLetterString(String s) {
            ...
            for (Map.Entry<Character, List<Integer>> entry : m.entrySet()) {
                ...
                for (int i = 1; i < idxs.size() - 1; i++) {
                    int left = idxs.get(i) - idxs.get(i - 1);
                    int right = idxs.get(i + 1) - idxs.get(i);
                    ans += left * right;
                }
            }
            return ans;
