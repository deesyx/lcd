...
public class MaximumNumberOfBallsInABox_One742 {
    public static void main(String[] args) {
        Solution solution = new MaximumNumberOfBallsInABox_One742().new Solution();
        solution.countBalls(19, 28);
    }
...
//            return ans;
            ...
            for (int i = lowLimit + 1; i <= highLimit; i++) {
                ...
                int cueIndex = preIndex - 9 * preCount9 + 1;
                m[cueIndex]++;
                ans = Math.max(ans, m[cueIndex]);
                preIndex = cueIndex;
            }
