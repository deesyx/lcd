...
// 
// Related Topics 深度优先搜索 广度优先搜索 图 拓扑排序 👍 1494 👎 0
...
public class CourseSchedule_Two07 {
    public static void main(String[] args) {
        Solution solution = new CourseSchedule_Two07().new Solution();
    }
