...
public class MeanOfArrayAfterRemovingSomeElements_One619 {
    public static void main(String[] args) {
        Solution solution = new MeanOfArrayAfterRemovingSomeElements_One619().new Solution();
    ...
    class Solution {
        public double trimMean(int[] arr) {
            ...
            return (double) sum / (arr.length - count - count);
        }
    }
