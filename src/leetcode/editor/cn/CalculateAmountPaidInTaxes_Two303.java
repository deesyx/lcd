...
public class CalculateAmountPaidInTaxes_Two303 {
    public static void main(String[] args) {
        Solution solution = new CalculateAmountPaidInTaxes_Two303().new Solution();
        solution.calculateTax(new int[][]{{3, 50}, {7, 10}, {12, 25}}, 10);
    }
