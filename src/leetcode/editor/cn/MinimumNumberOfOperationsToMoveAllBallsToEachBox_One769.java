...
public class MinimumNumberOfOperationsToMoveAllBallsToEachBox_One769 {
    public static void main(String[] args) {
        Solution solution = new MinimumNumberOfOperationsToMoveAllBallsToEachBox_One769().new Solution();
    ...
    class Solution {
        public int[] minOperations(String boxes) {
            ...
            for (int i = 1; i < n; i++) {
                ans[i] = ans[i - 1] + sum[i - 1] - (sum[n - 1] - sum[i - 1]);
            }
