...
// 
//
// Related Topics 栈 贪心 数组 哈希表 单调栈 👍 26 👎 0
...
public class MinimumOperationsToConvertAllElementsToZero_3542 {
    public static void main(String[] args) {
        Solution solution = new MinimumOperationsToConvertAllElementsToZero_3542().new Solution();
    }
