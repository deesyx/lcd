...
// 
// Related Topics 字符串 字符串匹配 👍 82 👎 0


package leetcode.editor.cn;

public class MaximumRepeatingSubstring_One668 {
    public static void main(String[] args) {
        Solution solution = new MaximumRepeatingSubstring_One668().new Solution();
