...
// 
//
// Related Topics 字典树 双指针 字符串 字符串匹配 👍 80 👎 0
...
public class CamelcaseMatching_One023 {
    public static void main(String[] args) {
        Solution solution = new CamelcaseMatching_One023().new Solution();
    }
    ...
    class Solution {
        ...
        private boolean check(String s, String t) {
            ...
            while (i < s.length() && j < t.length()) {
                while (i < s.length() && s.charAt(i) != t.charAt(j) && Character.isLowerCase(s.charAt(i))) {
                    i++;
                }
