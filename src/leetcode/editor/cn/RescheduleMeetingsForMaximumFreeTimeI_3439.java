...
// 
//
// Related Topics 贪心 数组 滑动窗口 👍 32 👎 0


package leetcode.editor.cn;

public class RescheduleMeetingsForMaximumFreeTimeI_3439 {
    public static void main(String[] args) {
        Solution solution = new RescheduleMeetingsForMaximumFreeTimeI_3439().new Solution();
        solution.maxFreeTime(34, 2, new int[]{0, 17}, new int[]{14, 19});
    }
