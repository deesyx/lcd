...
public class NumberOfLinesToWriteString_Eight06 {
    public static void main(String[] args) {
        Solution solution = new NumberOfLinesToWriteString_Eight06().new Solution();
        solution.numberOfLines(new int[]{10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10}, "abcdefghijklmnopqrstuvwxyz");
    }
    ...
    class Solution {
        public int[] numberOfLines(int[] widths, String s) {
            ...
            if (lineWith == 0) {
                return new int[]{lineCount - 1, 100};
            } else {
                return new int[]{lineCount, lineWith};
            }
        }
    }
