...
public class RemoveDuplicatesFromSortedArrayIi_Eight0 {
    public static void main(String[] args) {
        Solution solution = new RemoveDuplicatesFromSortedArrayIi_Eight0().new Solution();
