...
// 树中所有值 互不相同 
// 
// Related Topics 树 深度优先搜索 二叉树 👍 119 👎 0


package leetcode.editor.cn;

public class BinaryTreeColoringGame_One145 {
    public static void main(String[] args) {
        Solution solution = new BinaryTreeColoringGame_One145().new Solution();
    }
//leetcode submit region begin(Prohibit modification and deletion)
    ...
    class Solution {
        ...
        private TreeNode dfs(TreeNode node, int x) {
            ...
            return left != null ? left : dfs(node.right, x);
        }
