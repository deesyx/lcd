...
// 题目数据确保队列可以被重建 
// 
// Related Topics 贪心 树状数组 线段树 数组 排序 👍 1523 👎 0
...
public class QueueReconstructionByHeight_Four06 {
    public static void main(String[] args) {
        Solution solution = new QueueReconstructionByHeight_Four06().new Solution();
    }
